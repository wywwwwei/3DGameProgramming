...
public class Judge: MonoBehaviour {
    ...
    {
        Debug.Log("1:"+priestLeftNum+" 2:"+priestRightNum+" 3:"+devilLeftNum+" 4:"+devilRightNum);
        if(priestLeftNum + devilLeftNum == 6){
            cur_status = GameStatus.Win;
        }
        else if(priestLeftNum != 0 && priestLeftNum<devilLeftNum)
        {
            cur_status = GameStatus.Lose;
        }
        else if(priestRightNum!=0 && priestRightNum<devilRightNum){
            cur_status = GameStatus.Lose;
        }
        else{
